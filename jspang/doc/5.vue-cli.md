Vue-cli 是 vue 官方出品的快速构建单页应用的脚手架，牵扯的东西很多，有 webpack，npm，nodejs，babel 等。
...
![vue_cli_template](./imgs/vue_cli_template.png)
...
通过代码可以看出这里引进了 App 的组件和\<App/>的模板，它是通过 **import App from ‘./App’代码引入**。 我们找到 App.vue 文件，打开查看。
